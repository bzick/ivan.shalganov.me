<img align="right" src="https://raw.githubusercontent.com/bzick/ivan.shalganov.me/master/me.jpeg" width="160">
...
Стараюсь держать себя в техонологическом тонусе и не застревать на определённых технологиях. Стараюсь изучить разные подходы к разработке и технологии, с целью улучшить проект или сделать разработку лучше.
...
- **SphinxSearch**. Долгое время (до 2015 года) активно использовался, но из-за отсутвия кластеризации была произведена миграция на ElastiSearch.

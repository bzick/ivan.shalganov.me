...
- Расположение: Нидерланды, Амсетрдам; Россия, Санкт-Петербург
...
### JetBrains N.V., `с июля 2022`

[jetbrains.com](https://jetbrains.com)

- Нидерланды, Амсетрдам.
- Должность: разработчик
- Роль в компании: Разработчик
- Уровень в компании: senior backend разработчик
- Обязанности:
  - Разработка на Go
 
### ООО "Мегагрупп", `февраль 2009 — июль 2022`

[megagroup.ru](https://megagroup.ru)

- Россия, Санкт-Петербург.
- Должность: разработчик
- Роль в компании: Разработчик, Техлид, Архитектор
- Уровень в компании: senior backend разработчик, middle frontend разработчик.
- Обязанности:
  - ведения стека технологии подопечных проектов и изменение его
  - контроль и изменение процессов разработки проектов.
  - контроль и избавление от тех. долга (legacy)
  - проектирование приложений, включая инфраструктуру и сбор требований (SLA)
  - ведение разработки проектов от планирования до сопровождения.
...
### ООО "Интернет", `ноябрь 2006 - февраль 2009`
...
- **Golang**, 4 года опыта.
 ...
 Приходилось писать микросервисы с большим количеством единовременных соединений, большим количеством RPS, большим потоком входных данных.
...
Не имею проблем с коммуникацией. Всегда открыт к общению и обсуждению. Большой опыт работы в децентрализованной команде.
Способен решать административные задачи.

- Согласование требований с бизнесом.
- Сбор команды под проект и согласование ТЗ с командой.
- Навыки работы в распределённой команде
- Навыки тимлида в распределённой команде.
...
- Свободное чтение документации, но иногда нужен словарь.
- Свободная переписка в чате, мысли доносить умею.
...
- Нестадартное мышление.

Имею права категории B, имею личный автотранспорт.
